...
┌──(jars㉿jars)-[~/picoCTF/forensic/MacroHard]
└─$ wget https://mercury.picoctf.net/static/d3dd8cd51524d9fafcccd1b7d55f85e7/Forensics%20is%20fun.pptm
--2024-03-20 17:41:28--  https://mercury.picoctf.net/static/d3dd8cd51524d9fafcccd1b7d55f85e7/Forensics%20is%20fun.pptm
...
Forensics is fun.pptm                                      100%[=======================================================================================================================================>]  97.75K   576KB/s    in 0.2s    

2024-03-20 17:41:28 (576 KB/s) - ‘Forensics is fun.pptm’ saved [100093/100093]
...
Convertimos esto que esta en base64 -> flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}
```
## Notas adicionales
## Referencias 