...
┌──(jars㉿jars)-[~/picoCTF/examen3/ftw]
└─$ cat exp.py 
# Valores hexadecimales del flag
hex_values = [
    "70", "69", "63", "6f", "43", "54", "46", "7b", "41", "53", "43", "49", "49", "5f",
    "49", "53", "5f", "45", "41", "53", "59", "5f", "33", "43", "46", "34","42", "46", "41","44","7d"
]

# Convertir valores hexadecimales a ASCII
ascii_flag = ''.join(chr(int(hex_value, 16)) for hex_value in hex_values)

# Imprimir el flag ASCII
print(ascii_flag)
